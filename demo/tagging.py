...
def tagging(request):
    if (request.method == "POST"):
        ...
        collection.delete_many(
            {'entity1Pos': post.get('entity1Pos'), 'entity1': post.get('entity1'), 'entity2Pos': post.get('entity2Pos'),
             'entity2': post.get('entity2Pos'), 'relation': post.get('relation'), 'statement': post.get('statement')})
